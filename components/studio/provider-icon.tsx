...
// The OpenAI knot, carried from svgl (MIT) as a single currentColor path —
// Simple Icons dropped the brand, and the registry component ships four
// variants (light, dark, two wordmarks) where one recolorable mark is the
// whole need: states come from CSS color, never from separate assets.
...
// The Grok mark, carried from svgl (MIT) the same way the OpenAI knot is:
// one currentColor shape instead of the registry's four generated variants.
...
export function ProviderIcon({
  ...
  const Mark = MARKS.get(provider) ?? OpenAiMark;
