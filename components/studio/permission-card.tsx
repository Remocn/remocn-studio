...
export function PermissionCard({
  ...
  return (
    <Card
      ...
      size="sm"
      className="ring-none bg-input/50"
    >
      <CardHeader>
        <CardTitle>{permissionTitle(permission.reason)}
        ...
        {target === null ? null : (
          <p className="wrap-break-word whitespace-pre-wrap rounded-lg bg-muted/50 px-2.5 py-1.5 font-mono text-xs text-foreground leading-relaxed">
            {target}
          </p>
        )}
      </CardHeader>
